...
inline fp16_t<F> &fp16_t<F>::operator+=(fp16_t<F> b)
{
...
template <unsigned int F>
inline fp16_t<F> operator+(fp16_t<F> a, fp16_t<F> b)
{
	fp16_t<F> result(a);
	result += b;
	return result;
...
template <unsigned int F>
inline fp16_t<F> &fp16_t<F>::operator+=(int32_t b)
{
#ifdef CHECK_OVERFLOW
...
template <unsigned int F>
inline fp16_t<F> operator+(fp16_t<F> a, int32_t b)
{
	fp16_t<F> result(a);
	result += b;
	return result;
...
template <unsigned int F>
inline fp16_t<F> operator+(int32_t a, fp16_t<F> b)
{
	return b + a;
}
...
// Unary minus (invert)
template <unsigned int F>
inline fp16_t<F> operator-(fp16_t<F> a)
{
	return fp16_t<F>::fromRaw(-a.raw());
}
...
template <unsigned int F>
fp16_t<F> &fp16_t<F>::operator/=(fp16_t<F> b)
{
	if (b.value == 0)
	{
#ifdef CHECK_ERROR
...
template <unsigned int F>
fp16_t<F> operator/(fp16_t<F> a, fp16_t<F> b)
{
	fp16_t<F> result(a);
	result /= b;
	return result;
...
template <unsigned int F>
fp16_t<F> &fp16_t<F>::operator/=(int32_t b)
{
	if (value == 0)
	{
#ifdef CHECK_ERROR
...
template <unsigned int F>
fp16_t<F> operator/(fp16_t<F> a, int32_t b)
{
	fp16_t<F> result(a);
	result /= b;
	return result;
...
template <unsigned int F>
fp16_t<F> operator/(int32_t a, fp16_t<F> b)
{
	fp16_t<F> result(a);
	result /= b;
	return result;
...
template <unsigned int F>
inline fp16_t<F> &fp16_t<F>::operator<<=(uint32_t shift)
{
#ifdef CHECK_OVERFLOW
	fpassert_overflow((highestBitSet(value) + shift) > 15, PRINT_MESSAGE);
#endif
	value <<= shift;
	return *this;
}
...
template <unsigned int F>
inline fp16_t<F> operator<<(fp16_t<F> a, uint32_t shift)
{
	fp16_t<F> result(a);
	result <<= shift;
	return result;
...
fp16_t<F> sqrt(fp16_t<F> a)
{
	...
	return fp16_t<F>::fromRaw(static_cast<int32_t>(sqrt(static_cast<uint32_t>(a.raw()), F)));
}

template <unsigned int F>
fp16_t<F> sqrtFast(fp16_t<F> a)
{
	if (a.raw() <= 0)
	{
#ifdef CHECK_ERROR
	...
	return fp16_t<F>::fromRaw(static_cast<int32_t>(sqrtFast(static_cast<uint32_t>(a.raw()), F)));
}

template <unsigned int F>
fp16_t<F> sqrtRecip(fp16_t<F> a)
{
	if (a.raw() <= 0)
	{
#ifdef CHECK_ERROR
	...
	return fp16_t<F>::fromRaw(static_cast<int32_t>(sqrtRecip(static_cast<uint32_t>(a.raw()))));
}

template <unsigned int F>
fp16_t<F> sqrtRecipFast(fp16_t<F> a)
{
	if (a.raw() <= 0)
	{
#ifdef CHECK_ERROR
	...
	return fp16_t<F>::fromRaw(static_cast<int32_t>(sqrtRecipFast(static_cast<uint32_t>(a.raw()))));
}
