...
#pragma GCC diagnostic pop
        ...
        vec2_t &operator<<=(uint32_t shift)
        {
            x.value <<= shift;
            y.value <<= shift;
        }
        ...
        vec2_t &normalize()
        {
            const T l = sqrt(x * x + y * y);
            x /= l;
            y /= l;
            return *this;
        }
        T normalizeAndReturnLength()
        {
            const T l = sqrt(x * x + y * y);
            x /= l;
            y /= l;
...
#pragma GCC diagnostic pop
        ...
        vec3_t &operator<<=(uint32_t shift)
        {
            x.value <<= shift;
            y.value <<= shift;
            z.value <<= shift;
        ...
        vec3_t &normalize()
        {
            const T l1 = sqrtRecip(x * x + y * y + z * z);
            x *= l1;
            y *= l1;
            z *= l1;
            return *this;
...
#pragma GCC diagnostic pop
        ...
        vec4_t &operator<<=(uint32_t shift)
        {
            x.value <<= shift;
            y.value <<= shift;
            z.value <<= shift;
        ...
        vec4_t &normalize()
        {
            const T l1 = sqrt_recip(x * x + y * y + z * z + w * w);
            x *= l1;
            y *= l1;
            z *= l1;
            w *= l1;
