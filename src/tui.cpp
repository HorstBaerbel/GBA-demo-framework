...
namespace TUI
{
    ...
    void setup()
    {
        ...
        Memory::memcpy32(Tiles::TILE_BASE_TO_MEM<uint32_t>(Tiles::TileBase::Base0000), FONT_8X8_DATA, FONT_8X8_DATA_SIZE);
        // set up background 0 (text background) and 1 (text foreground) screen and tile map starts and set screen size to 256x256
        REG_BG0CNT = Backgrounds::control(Tiles::TileBase::Base0000, Tiles::ScreenBase::Base1000, Backgrounds::ScreenSize::Size0, Backgrounds::ColorDepth::Depth16, Backgrounds::Priority::Prio1);
        REG_BG1CNT = Backgrounds::control(Tiles::TileBase::Base0000, Tiles::ScreenBase::Base2000, Backgrounds::ScreenSize::Size0, Backgrounds::ColorDepth::Depth16, Backgrounds::Priority::Prio0);
    ...
    void fillBackground(Color color)
    {
        ...
        Memory::memset32(Tiles::SCREEN_BASE_TO_MEM<uint32_t>(Tiles::ScreenBase::Base1000), value, (Width * Height) >> 1);
    }
    ...
    void fillBackgroundRect(uint16_t x, uint16_t y, uint16_t w, uint16_t h, Color color)
    {
        ...
        auto background = Tiles::SCREEN_BASE_TO_MEM<uint16_t>(Tiles::ScreenBase::Base1000) + Width * y + x;
    ...
    void printChar(char c, uint16_t x, uint16_t y, Color backColor, Color textColor)
    {
        ...
        auto background = Tiles::SCREEN_BASE_TO_MEM<uint16_t>(Tiles::ScreenBase::Base1000);
        background[tileIndex] = 0x5F | ((static_cast<uint16_t>(backColor) & 15) << 12);
        auto text = Tiles::SCREEN_BASE_TO_MEM<uint16_t>(Tiles::ScreenBase::Base2000);
