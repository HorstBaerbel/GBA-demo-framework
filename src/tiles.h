...
namespace Tiles
{
    ...
    constexpr uint16_t backgroundConfig(TileBase tileBase, ScreenBase screenBase, ScreenSize screenSize = ScreenSize::Size_0, uint16_t paletteColors = 16, uint16_t priority = 0, bool mosaic = false)
    {
